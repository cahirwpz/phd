...
(SDEFUN |main| (($ |Void|))
       (SPROG ((|l| (|List| (|SingleInteger|))))
             (SETQ |l| '(5 15 2 20))
             (|print_SI| (|FOOLIST;sumi;LSi;4| |l| NIL)) (|print_eol|)
             (|print_SI| (|FOOLIST;sumr;LSi;6| |l| NIL)) (|print_eol|)
             (|print_SI| (|FOOLIST;leni;LSi;1| |l| NIL)) (|print_eol|)
             (|print_SI| (|FOOLIST;lenr;LSi;3| |l| NIL)) (|print_eol|)))
